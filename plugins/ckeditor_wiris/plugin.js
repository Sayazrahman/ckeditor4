...
try{
var doaminName=window.location.hostname;
if(doaminName=="was.wheebox.com" || doaminName=="wac.wheebox.com"){
	_wrs_int_conf_file = "https://wiris.wheebox.com/pluginwiris_engine/app/configurationjs";
}else if(doaminName=="localhost"){
	_wrs_int_conf_file = "https://uat.wheebox.com/pluginwiris_engine/app/configurationjs";
} 
_wrs_int_conf_file="";
}catch(e){}
